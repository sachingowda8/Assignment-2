...
All 20 questions attempted. Bonus sections also completed:
  ...
  Q4  - Age Calculator + Bonus
  Q5  - Bill Splitter
  Q6  - Grade Calculator
  Q7  - Temperature Converter
  Q8  - Leap Year Checker
  Q9  - Ticket Pricing System
  Q10 - ATM Simulator + History Bonus
  Q11 - Pattern Printer + 3 Patterns
  Q12 - Multiplication Table + Grid
  Q13 - Sum & Average + Median/Mode
  Q14 - Factorial Calculator
  Q15 - Prime Number Checker
  Q16 - Guessing Game + Difficulty
  Q17 - Palindrome Checker
  Q18 - Calculator Functions + extras
...
================================================
  ...
  - Q12 includes the full 10x10 multiplication grid (Bonus).
...
================================================
  ...
  2. Q10 (ATM): Enforcing the minimum balance of Rs.500 during withdrawal
     required computing the maximum available withdrawal first.

  3. Q15 (Prime Checker): Optimising the divisor check to sqrt(n) instead of n
